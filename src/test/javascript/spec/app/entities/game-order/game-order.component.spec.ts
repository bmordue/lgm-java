...
import { GameOrderComponent } from 'app/entities/game-order/game-order.component';
...
describe('Component Tests', () => {
    describe('GameOrder Management Component', () => {
        let comp: GameOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GameOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gameOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
