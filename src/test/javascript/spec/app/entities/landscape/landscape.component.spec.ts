...
import { LandscapeComponent } from 'app/entities/landscape/landscape.component';
...
describe('Component Tests', () => {
    describe('Landscape Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LandscapeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.landscapes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
